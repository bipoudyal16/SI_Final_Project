...
"""
   ...
   for row in records:
       ...
       location_details.append(str(row[5]))
       location_details.append(str(row[6]))
       location_details.append(str(row[7]))
       location_details.append(str(row[8]))
       location_details.append(str(row[9]))
